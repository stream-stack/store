...
require (
	...
	github.com/stream-stack/store/store/common v0.0.0-20210825083649-7fd253a4239c
...
replace (
	...
	//google.golang.org/grpc v1.39.0 => google.golang.org/grpc v1.27.0
	google.golang.org/grpc v1.39.0 => google.golang.org/grpc v1.33.2
